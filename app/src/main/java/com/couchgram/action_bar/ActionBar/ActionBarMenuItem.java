...
import com.couchgram.action_bar.AnimationCompat.ViewProxy;
import com.couchgram.action_bar.Components.FrameLayoutFixed;
...
public class ActionBarMenuItem extends FrameLayoutFixed {
    ...
    public void setBackground(int resBGColor) {
        iconView.setBackgroundResource(resBGColor);
    }
        ...
        if (value && searchContainer == null) {
            ...
            searchField.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    ...
                    if (clearButton != null) {
                        ViewProxy.setAlpha(clearButton, s == null || s.length() == 0 ? 0.0f : 1.0f);
                    }
                }
            ...
            if (needClearButton) {
                ...
                clearButton.setImageResource(R.drawable.search_del_all_btn);
